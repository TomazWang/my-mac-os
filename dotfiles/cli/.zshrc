...
plugins=(git npm zsh-syntax-highlighting git-flow alias-tips)
...
# ============ Shell dotfiles =================
for file in $HOME/.shell/{shell_exports,shell_alias,shell_functions,shell_config,shell_spaceship,shell_conda}; do
...
# unalias imgcat to avoid from conflict.
unalias imgcat
